...
function mainMenu(option = "", title) {
    switch (option.toLowerCase()) {
        ...
        default:
            saveOutput(`Error:\n"${option}" is a not valid command.\nPlease select "spotify-this-song", "movie-this", or "do-what-it-says".\n\n\n`);
...
function getMovie(title) {
    const api_url = `http://www.omdbapi.com/?apikey=31346850`;
    ...
    fs.readFile("random.txt", "utf8", (error, data) => {
        ...
        *********************************************************************/
        ...
        commands.forEach(c => {
            ...
            // Use indexOf instead of split, in case the title has a comma (formatting)
